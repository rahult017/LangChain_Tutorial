...
result_docs = vector_store.add_documents(docs)
...
# meta-data filtering
filter_result = vector_store.similarity_search_with_score(
    query="",
    filter={"team": team}
)
print("\n",filter_result)
...
updated_doc_vector = vector_store.get(include=['embeddings','documents', 'metadatas'])
print("\n",updated_doc_vector)